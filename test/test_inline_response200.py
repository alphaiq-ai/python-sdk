    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return InlineResponse200(
                data = openapi_client.models.inline_response_200_data.inline_response_200_data(
                    access_token = '0', 
                    challenge_parameters = openapi_client.models.challenge_parameters.ChallengeParameters(), 
                    id_token = '0', 
                    refresh_token = '0', 
                    token_type = '0', 
                    expires_in = 56, )
