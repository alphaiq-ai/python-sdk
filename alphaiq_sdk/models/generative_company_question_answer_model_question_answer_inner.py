...
class GenerativeCompanyQuestionAnswerModelQuestionAnswerInner(BaseModel):
    """
    GenerativeCompanyQuestionAnswerModelQuestionAnswerInner
    """ # noqa: E501
    id: StrictInt
    question_text: StrictStr
    question_response: StrictStr
    __properties: ClassVar[List[str]] = ["id", "question_text", "question_response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "question_response": obj.get("question_response")
        })
        return _obj
