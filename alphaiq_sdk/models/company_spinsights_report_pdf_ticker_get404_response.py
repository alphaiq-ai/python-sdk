...
class CompanySpinsightsReportPDFTickerGet404Response(BaseModel):
    """
    CompanySpinsightsReportPDFTickerGet404Response
    """ # noqa: E501
    errors: List[CompanySpinsightsReportPDFTickerGet404ResponseErrorsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [CompanySpinsightsReportPDFTickerGet404ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
